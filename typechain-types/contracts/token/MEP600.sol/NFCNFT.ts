...
export interface NFCNFTInterface extends utils.Interface {
  functions: {
    ...
    "nfcnftTag(bytes32)": FunctionFragment;
    "nftnfcTag(uint256)": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "nfcnftTag",
    values: [PromiseOrValue<BytesLike>]
  ): string;
  encodeFunctionData(
    functionFragment: "nftnfcTag",
    values: [PromiseOrValue<BigNumberish>]
  ): string;
  ...
  decodeFunctionResult(functionFragment: "nfcnftTag", data: BytesLike): Result;
  decodeFunctionResult(functionFragment: "nftnfcTag", data: BytesLike): Result;
...
export interface NFCNFT extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: NFCNFTInterface;
