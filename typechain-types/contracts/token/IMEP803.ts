...
export interface IMEP803Interface extends utils.Interface {
  functions: {
    "getTier()": FunctionFragment;
  };

  getFunction(nameOrSignatureOrTopic: "getTier"): FunctionFragment;
...
export interface IMEP803 extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: IMEP803Interface;
