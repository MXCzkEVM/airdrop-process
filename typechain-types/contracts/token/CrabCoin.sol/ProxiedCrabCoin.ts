...
export interface ProxiedCrabCoinInterface extends utils.Interface {
  functions: {
...
export interface ProxiedCrabCoin extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ProxiedCrabCoinInterface;
