...
export interface ProxiedEthMxcPriceAggregatorInterface extends utils.Interface {
  functions: {
...
export interface ProxiedEthMxcPriceAggregator extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ProxiedEthMxcPriceAggregatorInterface;
