...
export interface ProxiedERC6551RegistryInterface extends utils.Interface {
  functions: {
...
export interface ProxiedERC6551Registry extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ProxiedERC6551RegistryInterface;
