...
export interface ControllableUpgradeableInterface extends utils.Interface {
  functions: {
...
export interface ControllableUpgradeable extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ControllableUpgradeableInterface;
