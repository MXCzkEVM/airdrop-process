...
export interface ERC6551AccountImplementationInterface extends utils.Interface {
  functions: {
...
export interface ERC6551AccountImplementation extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ERC6551AccountImplementationInterface;
