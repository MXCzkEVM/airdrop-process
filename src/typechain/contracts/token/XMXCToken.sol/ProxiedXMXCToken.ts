...
export interface ProxiedXMXCTokenInterface extends utils.Interface {
  functions: {
...
export interface ProxiedXMXCToken extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ProxiedXMXCTokenInterface;
