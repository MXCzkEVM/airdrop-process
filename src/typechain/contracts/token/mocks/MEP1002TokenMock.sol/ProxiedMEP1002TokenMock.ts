...
export interface ProxiedMEP1002TokenMockInterface extends utils.Interface {
  functions: {
...
export interface ProxiedMEP1002TokenMock extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ProxiedMEP1002TokenMockInterface;
