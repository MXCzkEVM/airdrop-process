...
export interface ProxiedMEP1004TokenInterface extends utils.Interface {
  functions: {
...
export interface ProxiedMEP1004Token extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ProxiedMEP1004TokenInterface;
