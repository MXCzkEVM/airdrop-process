...
export interface ProxiedXMigrateTokenInterface extends utils.Interface {
  functions: {
...
export interface ProxiedXMigrateToken extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ProxiedXMigrateTokenInterface;
