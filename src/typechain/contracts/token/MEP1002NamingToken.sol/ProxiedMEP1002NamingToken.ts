...
export interface ProxiedMEP1002NamingTokenInterface extends utils.Interface {
  functions: {
...
export interface ProxiedMEP1002NamingToken extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ProxiedMEP1002NamingTokenInterface;
